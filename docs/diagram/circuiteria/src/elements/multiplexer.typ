...
#let multiplexer(
  ...
  let ports_final = (west: ports, east: ((id: "out"),))
  if sel-down {
    ports_final.insert("south", (id: "sel"))
  } else {
    ports_final.insert("north", (id: "sel"))
  }
  ...
  if sel-down {
    add-port(id, "south", (id: "sel"), (id + ".south-west", 50%, id + ".south-east"))
  } else {
    add-port(id, "north", (id: "sel"), (id + ".north-west", 50%, id + ".north-east"))
  }
}
